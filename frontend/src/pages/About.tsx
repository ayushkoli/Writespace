...
export default function About() {
  return (
    <div className={`${PAGE_SHELL} animate-fade-in pb-8`}>
      <MobilePageHeader
        title="About"
        subtitle="Creator credits & project info"
        showLogo={false}
      />
      ...
      <div className="px-4 sm:px-6 pt-6 sm:pt-8">
        <article className="card-premium rounded-3xl border border-border/40 overflow-hidden">
          <div className="p-6 sm:p-10">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-text-muted mb-3">
              Creator credits
            </p>
            ...
            <p className="text-text-secondary text-base sm:text-lg leading-relaxed font-medium max-w-2xl">
              A modern social writing app for sharing posts, following creators,
              and saving what you love built as a full-stack project with React,
              Node.js, and MongoDB.
            </p>
          </div>
